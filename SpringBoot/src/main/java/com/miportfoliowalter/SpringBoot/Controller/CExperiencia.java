...
import com.miportfoliowalter.SpringBoot.Entity.Experiencia;
import com.miportfoliowalter.SpringBoot.Security.Controller.Mensaje;
import com.miportfoliowalter.SpringBoot.Service.SExperiencia;
import dtoExperiencia.dtoExperiencia;
...
public class CExperiencia {
    ...
    public ResponseEntity<?> delete (@PathVariable("id") int id ){
        ...
        return new  ResponseEntity(new Mensaje("La Id fue eliminada"), HttpStatus.OK);
    }  
